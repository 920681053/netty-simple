 ...
 * <p>
 * 3.ChannelHandlerContext 对象提供了许多操作，使你能够触发各种各样的 I/O 事件和操作。这里我们调用了 write(Object) 方法来逐字地把接受到的消息写入。请注意不同于 DISCARD 的例子我们并没有释放接受到的消息，这是因为当写入的时候 Netty 已经帮我们释放了。
 * <p>
...
public class DiscardServerHandler extends ChannelInboundHandlerAdapter { //(1)
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {//(2)
        System.err.println("服务端收到消息：" + msg.toString());
        ctx.write(msg); //(3)
        ctx.flush(); //(4)
    }
